...
#include <Lessons/OmnidirectionalSM/OmnidirectionalSM.h>
...
void Renderer::Run() 
{
    ...
    while(!glfwWindowShouldClose(_window))
    {
        ...
        OmnidirectionalSM::draw(activeCamera, currentFrame);
