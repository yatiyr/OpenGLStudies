...
#include <Lessons/GammaCorrection/GammaCorrection.h>
...
void Renderer::ProcessInput()
{
    ...
    GammaCorrection::processInput(_window);
}
...
void Renderer::Run() 
{
    ...
    while(!glfwWindowShouldClose(_window))
    {
        ...
        GammaCorrection::draw(activeCamera);
